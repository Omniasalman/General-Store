...
public class Hypred extends BaseTest {
    @Test
    public void HyperdApp() throws InterruptedException {
        ...
        //so you cant user driver anymore
         Set<String> context =driver.getContextHandles(); //will gie you two one is your native app and other is the webView app
